...
# release models
wget https://raw.githubusercontent.com/richzhang/colorization/master/models/colorization_deploy_v1.prototxt \
    -O ./resources/colorization_deploy_v1.prototxt
...
wget http://eecs.berkeley.edu/~rich.zhang/projects/2016_colorization/files/demo_v1/colorization_release_v1.caffemodel \
    -O ./resources/colorization_release_v1.caffemodel
